...
import type { CompleteConversationResponse } from '../responses';

export type CompleteConversationInput = Readonly<{
  conversationId: string;
}>;

export class CompleteConversationUseCase extends UseCase<
  CompleteConversationInput,
  CompleteConversationResponse
> {
  public readonly name = 'CompleteConversation';
  ...
  public async execute(
  ...
  ): Promise<Result<CompleteConversationResponse, ApplicationError>> {
    ...
    const outcome = conversation.complete(
